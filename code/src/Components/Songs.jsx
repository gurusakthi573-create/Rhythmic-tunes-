...
function Songs() {
  ...
  const filteredItems = items.filter((item) => {
    ...
    return (
      ...
      <div className="songs-container" style={{width:"1300px",color:"silver",display:"inline-flex"}}>
        <div className="container mx-auto p-3">
          <h2 className="text-3xl font-semibold mb-4 text-center" style={ {cursor:"pointer"}}>SONGS LIST🎧 </h2>
