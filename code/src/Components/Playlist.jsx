...
function Playlist() {
  ...
  return (
    <div >
      <div style={{ marginLeft: '230px' ,color:"silver"}}>
        <div className="container mx-auto p-8">
          <h2 className="text-3xl font-semibold mb-4 text-center">PLAY LIST▶️</h2>
          <center>
         
          <Table  responsive style={{width:"1100px",justifyContent:"center",display:"flex-block",}} >
            ...
            <thead >
              <tr>
                ...
                <th >Actions</th>
                <th  > <Button
            style={{ backgroundColor: '#000000', border: 'none',width:"60px",display:'flex', justifyContent:"center" }}
            ...
            <tbody>
              {playlist.map((item, index) => (
                <tr key={item.id}>
                  ...
                  <td>
                    <Button
                      style={{ backgroundColor: 'red', border: 'none',color:"#000000",width:"100px",padding:"10px",paddingBottom:"15px",justifyContent:"center" }}
